...
namespace Hanoikids\Forum\Helper;
	...
	public function mediaUploadImage(
		...
		if ($imageRequest && strlen($fileName)) {
			try {
				...
				*/
				if ($makeResize) {
					//$mediaAbsolutePath la cai path den anh?s
					$this->_resizeImage(
				...
				// dung lop abstract model luu du lieu xong chuyen no ve cai image path trong pub/media
